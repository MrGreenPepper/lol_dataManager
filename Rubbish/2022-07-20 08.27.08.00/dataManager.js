...
await (async function extractProcedure() {
	 ...
	 *
	 */
	let _extr = new extractor();
	if (procedure[1][0] == true) await _extr.ex_metaData();
	if (procedure[1][1] == true) await _extr.ex_skillTabs();
	if (procedure[1][2] == true) await _extr.ex_skillOrder();
	if (procedure[1][3] == true) await _extr.ex_masteries();
